# SAP ABAP Student Table

This project demonstrates a **Managed RAP (RESTful ABAP Programming Model) Scenario** developed in **SAP ABAP Cloud** for maintaining student data.
